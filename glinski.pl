...
cutoff(Move, Value, Depth, Alpha, Beta, Moves, Position, Player, Record, BestMove)  :-  
                                                                    Value =< Alpha,
                                                                    getAIMove(Moves, Position, Depth, Alpha, Beta, Player, Record, BestMove).

%-----------------------------------------------------------------------------------
%                       EVALUATION FUNCTION FOR THE LEAF NODE
%-----------------------------------------------------------------------------------

evalVal([], _, _, 0).
evalVal([ [X1, Y1, Player1, A] | T], Player, Player1, Value)    :-   
                                                        getVal(A, Value1),
                                                        evalVal(T, Player, Player1, Value2),
                                                        Value is Value2 + Value1.
evalVal([ [X1, Y1, Player, A] | T], Player, Player1, Value)   :-
                                                        getVal(A, Value1),
                                                        evalVal(T, Player, Player1, Value2),
                                                        Value is Value2 - Value1.
